...
export default function Synopsis() {
  return (
    <main className="bg-[#FBF8F3] overflow-x-hidden">
          ...
          <FlyInRight>
            <div className="w-[419px] h-[94px]">
              ...
              <p className="mt-5 text-[16px] text-center">
                ...
                unwavering passion for music and dreams of becoming a pop star.
              </p>
            </div>
          </FlyInRight>
        </div>
          ...
          <FlyInLeft>
            <div className="w-[419px] h-[166px]">
              ...
              <p className="mt-5 text-[16px] text-center">
                ...
                as he had envisioned. Despite his best efforts, Galih struggles
                to capture the attention of record labels and loses sight of his
                life's purpose.
              </p>
            </div>
          </FlyInLeft>
        ...
        <div className="w-[1134px] flex justify-center items-center space-x-[120px]">
          ...
          <FlyInRight>
            <div className="w-[419px] h-[142px]">
              ...
              <p className="mt-5 text-[16px] text-center">
                To make matters worse, Galih discovers that his sister's success
                may not be what it seems. Nevertheless, with the help of his new
                friends that he befriended along the way, Galih learns to
                reconcile with life and reassess what it means to live.
              </p>
            </div>
          </FlyInRight>
        </div>
