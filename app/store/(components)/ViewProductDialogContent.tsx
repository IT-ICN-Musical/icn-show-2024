...
type ViewProductDialogContentProps = StoreItemData & {
    open: boolean;
    onClose: () => void;
};
    ...
    const saveAndClose = () => {
        ...
        const userItem: CartItem = {
            ...
            product: audienceNames.map((audienceNamesForProduct, index) => ({
                productId: index + 1,
                audience: audienceNamesForProduct.map(
                    (audienceName, ticketIndex) => ({
                    ...
                    <div className="flex flex-col pt-2 lg:py-8 lg:px-1">
                        ...
                        <div className="text-[0.7rem] md:text-xs my-1 italic">
                            *Kindly make sure to click{" "}
                            <span className="font-bold">Save and Close</span> to
                            save your order.
                        </div>
                    </div>
                </div>
                        ...
                        {isEmptyInput && (
                            <div className="flex items-center justify-center">
                                <p className="text-red-500 mb-2 text-xs sm:text-sm lg:text-base">
                                    Warning: Please fill in all input boxes
                                    before closing.
                                </p>
                            </div>
                        )}
